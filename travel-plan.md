...
- [ ] Confirm the Haneda terminal for MM877. Terminal 1 is domestic, so the old Terminal 1 note should not be used.
- [ ] Choose and reserve the Shanghai hostel.
- [ ] Decide whether 30 August is a Shanghai day or a Hangzhou day trip. Do not try to do both properly in one day.
- [ ] Ask a Shanghai friend which robotaxi service and operating zone visitors can currently use.
- [ ] Reserve the Wuhan → Shenzhen train.
- [ ] Decide the 4–5 September William/Hong Kong branch.
- [ ] Book Hong Kong accommodation for 5–7 and 10–11 September.
- [ ] Confirm the Hong Kong → Zhuhai ferry terminal and sailing.
- [ ] Plan Macau → Zhuhai Station → Ganzhou as a cross-border journey; there is no mainland railway departure from Macau itself.
- [ ] Reserve the Ganzhou → Hong Kong train.
- [ ] Copy the exact UO624 times from the booking confirmation.
- [ ] Set up mainland connectivity, offline maps, and Alipay/WeChat Pay before departure.
...
- Try the low-cost 520 heritage bus through the Song City sights, then walk Yugu Terrace, the old wall, and the ancient pontoon bridge.
- Keep 10 September mostly flexible before the direct evening train to Hong Kong.
